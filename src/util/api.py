...
class SQAPIHandler(object):
    ...
    def _request(self, method, endpoint, files=None, use_query_param=False, **data):
        call = getattr(self._session, method.lower())
        url = self._get_url(endpoint)

        if use_query_param and data:
            params = [f'{key}={data[key]}' for key in data]
            url = f"{url}?{'&'.join(params)}"
        # print(f"request: {url}, method: {method}, data: {data}")
    ...
    def get_metrics(self, fields=None):
        ...
        while page_num * page_size < n_metrics:
            res = self._request("get", "/api/metrics/search", use_query_param=True, **qs).json()
            page_num = res["p"]
            page_size = res["ps"]
            n_metrics = res["total"]
    ...
    def get_rules(self, active_only=False, profile=None, languages=None, custom_only=False, f=None):
        qs = {"is_template": "no", "statuses": "READY", "ps": 500}
        ...
        while page_num * page_size < n_rules:
            res = self._request("get", "/api/rules/search", use_query_param=True, **qs).json()
    ...
    def get_resources_debt(self, resource=None, categories=None, include_trends=False, include_modules=False):
        ...
        res = self._request("get", "/api/resources", use_query_param=True, **params).json()
    ...
    def get_issues(self, languages=None, componentKeys=None, rules=None):
        ...
        while page_num * page_size < n_issues:
            res = self._request("get", "/api/issues/search", use_query_param=True, **params).json()
            page_num = res["p"]
            page_size = res["ps"]
            n_issues = res["total"]
    ...
    def ce_task(self, id_, additionalFields=None):
        ...
        res = self._request("get", "/api/ce/task", use_query_param=True, **params).json()
        return res
    ...
    def get_settings(self, keys=None, component=None):
        ...
        if component is not None:
            params["component"] = component
        res = self._request("get", "/api/settings/values", use_query_param=True, **params)
        return res
    ...
    def get_component_measures(self, metricKeys, component, additionalFields=None):
        ...
        if additionalFields is not None:
            params["additionalFields"] = additionalFields
        res = self._request("get", "/api/measures/component", use_query_param=True, **params).json()
        return res

    def apply_license(self, license):
        params = {"license": license}
        res = self._request("post", "/api/editions/apply_license", **params).json()
        return res
    ...
    def qualityprofiles_search(self, project=None, language=None, qualityProfile=None, defaults=None):
        ...
        res = self._request("get", "/api/qualityprofiles/search", use_query_param=True, **params).json()
        return res
    ...
    def qualityprofiles_export(self, exporterKey=None, language=None, qualityProfile=None):
        ...
        if qualityProfile is not None:
            params["qualityProfile"] = qualityProfile
        res = self._request("get", "/api/qualityprofiles/export", use_query_param=True, **params)
        return res
